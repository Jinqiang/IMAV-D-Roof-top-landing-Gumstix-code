...
protected:
	BOOL m_bTaskFinish;
	enum {READY, ENGINE_UP, TAKEING_OFF, TRANSITION_1, PATH_1, VISION_INITIALIZATION, VISION_GUIDANCE, TASK, TRANSITION_2, PATH_2, LANDING, ENGINE_DOWN, GROUND, HOLD} m_mode;
